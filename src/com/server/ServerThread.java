                ...
                try {
                    ...
                    switch (cmd) {
                        case ServerCommands.CHAT_COMMAND:
                            ...
                            str = str.delete(0, 9);
                            notifyToUsersInRoom(ServerCommands.CHAT_COMMAND+"|" + this.clientName+"|"+str.toString());
                            break;
                        ...
                        case ServerCommands.LEAVE_ROOM_COMMAND:
                            ...
                            clientRoom = "";
                            removeUserRoom();
                            this.appendMessage("\n["+sdf.format(new Date())+"] User \""+clientName+"\" has left the room:\n"+room);
                            notifyToUsersInRoom(room, "CMD_ONLINE_THIS_ROOM"+getUsersAtRoom(room));
                            notifyToUsersInRoom(room, clientName+" has just left this room!");
                        ...
                        case "CMD_CHECK_NAME":
                            ...
                            if(isUserExist) {
                                ...
                                this.appendMessage("\n["+sdf.format(new Date())+"] User \""+clientName+"\" has joined the server");
